...
export const SEO_CONFIG = {
  ...
  siteUrl: 'https://aquamobility.co.kr',
  ...
  defaultOgImage: 'https://aquamobility.co.kr/static/og-default.jpg',
  defaultKeywords: '수륙양용버스,수륙양용투어,수륙양용버스예약,수륙양용시티투어,아쿠아모빌리티,아쿠아모빌리티코리아,통영수륙양용버스,부여수륙양용버스,합천수륙양용버스,수륙양용관광,통영해양관광,부여관광,합천관광,수상투어,amphibious bus tour korea',
  twitterHandle: '@aquamobilitykr',
  locale: 'ko_KR',
  organization: {
    name: '아쿠아모빌리티코리아',
    url: 'https://aquamobility.co.kr',
    logo: 'https://aquamobility.co.kr/static/logo.png',
    contactPoint: {
      telephone: '1588-0000',
  ...
  searchConsole: {
    ...
    naverVerification: '20f29f9ec38da506370ab5429c91a30eb1ea4bb1', // 네이버 서치어드바이저 소유확인 코드
    bingVerification: '',
  },
...
export const REGION_SEO: Record<string, {
  ...
  buyeo: {
    ...
    ogImage: 'https://aquamobility.co.kr/static/og-buyeo.jpg',
    canonicalUrl: 'https://aquamobility.co.kr/reservation/buyeo',
    h1: '부여 수륙양용버스 투어 예약',
    h2s: [
      '백마강 수륙양용버스 코스 안내',
      '부여 수륙양용투어 운행시간 및 요금',
    ...
    localBusiness: {
      ...
      url: 'https://aquamobility.co.kr/reservation/buyeo',
      ...
      image: 'https://aquamobility.co.kr/static/og-buyeo.jpg',
    },
    faq: [
    ...
    breadcrumbs: [
      { name: '홈', url: 'https://aquamobility.co.kr' },
      { name: '수륙양용투어 예약', url: 'https://aquamobility.co.kr/reservation' },
      { name: '부여 수륙양용투어', url: 'https://aquamobility.co.kr/reservation/buyeo' },
    ],
    smartplace: {
      ...
      reservationUrl: 'https://aquamobility.co.kr/reservation/buyeo',
      representativeImage: 'https://aquamobility.co.kr/static/og-buyeo.jpg',
    },
  },
  tongyeong: {
    ...
    ogImage: 'https://aquamobility.co.kr/static/og-tongyeong.jpg',
    canonicalUrl: 'https://aquamobility.co.kr/reservation/tongyeong',
    ...
    localBusiness: {
      ...
      url: 'https://aquamobility.co.kr/reservation/tongyeong',
      ...
      image: 'https://aquamobility.co.kr/static/og-tongyeong.jpg',
    },
    faq: [
    ...
    breadcrumbs: [
      { name: '홈', url: 'https://aquamobility.co.kr' },
      { name: '수륙양용투어 예약', url: 'https://aquamobility.co.kr/reservation' },
      { name: '통영 수륙양용투어', url: 'https://aquamobility.co.kr/reservation/tongyeong' },
    ],
    smartplace: {
      ...
      phone: '055-640-0000',
      openingHours: '매일 09:30~17:00 (기상악화 시 운휴)',
      reservationUrl: 'https://aquamobility.co.kr/reservation/tongyeong',
      representativeImage: 'https://aquamobility.co.kr/static/og-tongyeong.jpg',
    },
  },
  hapcheon: {
    ...
    ogImage: 'https://aquamobility.co.kr/static/og-hapcheon.jpg',
    canonicalUrl: 'https://aquamobility.co.kr/reservation/hapcheon',
    h1: '합천 수륙양용버스 투어 예약',
    h2s: [
      '합천호 수륙양용버스 코스 안내',
      '합천 수륙양용투어 운행시간 및 요금',
    ...
    localBusiness: {
      ...
      url: 'https://aquamobility.co.kr/reservation/hapcheon',
      ...
      image: 'https://aquamobility.co.kr/static/og-hapcheon.jpg',
    },
    faq: [
    ...
    breadcrumbs: [
      { name: '홈', url: 'https://aquamobility.co.kr' },
      { name: '수륙양용투어 예약', url: 'https://aquamobility.co.kr/reservation' },
      { name: '합천 수륙양용투어', url: 'https://aquamobility.co.kr/reservation/hapcheon' },
    ],
    smartplace: {
      ...
      reservationUrl: 'https://aquamobility.co.kr/reservation/hapcheon',
      representativeImage: 'https://aquamobility.co.kr/static/og-hapcheon.jpg',
    },
  },
};
